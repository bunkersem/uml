...
graph.addCell.call(graph ,Object.keys(classes).map(k => classes[k]));
...
const _this = this;
_.each(relations, function(r) { graph.addCell.bind(null, r) }.bind(null));

var randObj = {};

$(document).on('click', '#createNew', function(e) {
    var woman = new uml.Class({
        position: { x:450  , y: 500 },
        size: { width: 180, height: 50 },
        name: 'Woman',
        methods: ['+ giveABrith(): Person []'],
